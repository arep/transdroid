Transdroid
==========
UPDATE: Compiled APK [transdroidmaster.apk](https://github.com/arep/transdroid/blob/master/transdroidmaster.apk?raw=true) since offical release does not include the bugfix for adding torrents.
